...
public class BtbKpiWidgetProvider extends AppWidgetProvider {
    private static final String PREFERENCES = "btb_kpi_widget";
    ...
    private static final int COLOR_ERROR = Color.rgb(220, 65, 65);
    private static final int COLOR_TRACK = Color.rgb(48, 67, 83);
    private static final int COLOR_TEXT = Color.WHITE;
    private static final int COLOR_MUTED = Color.rgb(159, 176, 193);
    ...
    public static void updateAllWidgets(Context context) {
        ...
        ComponentName provider = new ComponentName(context, BtbKpiWidgetProvider.class);
    ...
    private static RemoteViews createViews(Context context) {
        ...
        BigDecimal safeProfit = superProfit == null ? BigDecimal.ZERO : superProfit;
    ...
    private static Bitmap createDonut(
            ...
            String centerText,
            int centerColor) {
        int size = dpToPx(context, 112);
        float strokeWidth = dpToPx(context, 12);
        ...
        if (total > 0) {
            float primarySweep = 360f * Math.max(primaryValue, 0) / total;
        ...
        text.setTextSize(spToPx(context, centerText.length() > 6 ? 14 : 18));
