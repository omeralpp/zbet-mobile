...
- A floating bell shortcut in the mobile Launchpad opens Android’s BTB notification settings, where all notification sound or either channel can be muted independently. Channels are created once so Android preserves later user sound and vibration preferences.
