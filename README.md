...
- The football control can be repositioned with a press-and-hold drag; its position persists across Launchpad navigation and is clamped inside the viewport. Notification settings remain available as the bell inside this menu, where all notification sound or either channel can be muted independently.
